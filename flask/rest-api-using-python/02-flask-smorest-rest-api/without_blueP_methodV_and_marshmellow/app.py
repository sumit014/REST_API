...
def get_info_about_a_store(store_id):
    try:
...
@app.get("/item")
def get_all_items():
    return f"Items: list({items.values()})"


@app.get("/item/<string:item_id>")
def get_info_about_an_item(item_id):
    try:
